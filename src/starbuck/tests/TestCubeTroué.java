...
public class TestCubeTroué extends TestObjet{
    ...
    public void testScene()
    {
        ...
        scene().add(new TRI(new Point3D(0,0,0),new Point3D(0,1,0), new Point3D(0,1,0), Color.red));
        scene().add(new TRI(new Point3D(0,1,1),new Point3D(0,1,0), new Point3D(0,1,0), Color.red));
