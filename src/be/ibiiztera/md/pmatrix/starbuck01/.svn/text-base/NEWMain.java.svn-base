...
public class NEWMain extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        previewEditor1 = new be.ibiiztera.md.pmatrix.starbuck01.PreviewEditor();
        jScrollPaneEditor = new javax.swing.JScrollPane();
        controlsEditor1 = new be.ibiiztera.md.pmatrix.starbuck01.ControlsEditor();
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
                ...
                private void sv_edtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sv_edtActionPerformed
                    if(pc.modifierModele(controlsEditor1.getText()))
                    {
                        pc.modeleModifie();
                        controlsEditor1.setText(pc.modeleTXT());
                        jFormattedTextField1.setText(java.util.ResourceBundle.getBundle("starbuck01/Bundle").getString("NOUVEAU MODELE OK"));
                    }
                    else
                    {
                        jFormattedTextField1.setText(java.util.ResourceBundle.getBundle("starbuck01/Bundle").getString("ERREUR"));
    ...
    */
    ...
    private be.ibiiztera.md.pmatrix.starbuck01.ControlsEditor controlsEditor1;
    ...
    private be.ibiiztera.md.pmatrix.starbuck01.PreviewEditor previewEditor1;
